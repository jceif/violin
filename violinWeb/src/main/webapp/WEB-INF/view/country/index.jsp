...
<%@include file="../base/pageBase.jsp"%>
<html>
<head>
    <title>Mybatis分页插件 - 测试页面</title>
    <%@include file="../base/headBase.jsp"%>
</head>
<body>
<div class="wrapper">
    <div class="middle">
        <h1 style="padding: 50px 0 20px;">国家(地区)列表</h1>
        <form action="${pageContext.request.contextPath}/${controllerName}/list" method="post">
        ...
        <table class="gridtable" style="width:100%;">
            <thead>
            <tr>
                <th colspan="4">查询结果 - [<a href="${pageContext.request.contextPath}/${controllerName}/view">新增国家(地区)</a>]</th>
            </tr>
            <tr>
                <th>ID</th>
                <th>国家(地区)名</th>
            ...
            <c:forEach items="${pageInfo.list}" var="country">
                <tr>
                    ...
                    <td style="text-align:center;">[<a
                            href="${pageContext.request.contextPath}/${controllerName}/view?id=${country.id}">修改</a>] -
                        [<a href="${pageContext.request.contextPath}/${controllerName}/delete?id=${country.id}">删除</a>]
                    </td>
                </tr>
            </c:forEach>
            </tbody>
